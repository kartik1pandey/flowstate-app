-- FlowState App - Supabase Database Setup
-- Run this in Supabase SQL Editor if tables don't auto-create
...
WHERE table_schema = 'public' 
  AND table_name IN ('users', 'user_settings', 'flow_sessions', 'interventions', 'media')
ORDER BY table_name;
