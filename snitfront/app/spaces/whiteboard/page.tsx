  ...
  const handleEndSession = async () => {
    try {
      ...
      await sessionsAPI.create({
        ...
        endTime: new Date(),
        duration: Math.floor(totalStrokeTime / 1000),
        focusScore,
        ...
        whiteboardMetrics: {
          ...
          eraserUses,
          toolSwitches,
          averageStrokeSpeed: strokes > 0 ? (totalStrokeTime / strokes) : 0,
          creativityScore,
        },
        metrics: {
          avgTypingSpeed: 0,
          tabSwitches: 0,
          mouseActivity: strokes,
          fatigueLevel: 0,
        },
        triggers: ['Creative session'],
        breakers: [],
        interventions: [],
        notes: 'Whiteboard session',
      });
      
      console.log('Whiteboard session saved successfully');
    } catch (error) {
