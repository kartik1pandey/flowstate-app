              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="pt-3 space-y-2">
                    <MetricRow label="Flow Score" value={`${Math.round(flowScore)}/100`} />
                    <MetricRow label="Session Time" value={`${Math.floor(timeLeft / 60)}m`} />
                    <MetricRow label="Cycles" value={`${cyclesCompleted}/${selectedPreset.cycles}`} />
                  </div>
                </div>
              </div>
            )}
